...
const SwiperPrices = () =>
  <Swiper
    ...
    <SwiperSlide >
      <CardPrice
        ...
        description='Бот - автоответчик, моментально отвечающий всем клиентам в любое время суток, что в разы повышает вероятность конверсии. В ночное и нерабочее
          время бот способен отвечать различными сообщениями. В Instagram профессиональные магазины часто используют такого бота для привлечения трафика на сайт.'
        price='3 900'
        timing='1 день' />
    </SwiperSlide>
    ...
    <SwiperSlide>
      <CardPrice
        title='Автоматизация работы с клиентами'
        description='В эту категорию попадают стандартные функции по взаимодействию с клиентами : Запись на прием, поддержка по заказам.'
        price='от 29 000'
        timing='от 7 дней' />
    </SwiperSlide>
